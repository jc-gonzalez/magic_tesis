...
{Difference of vertical heights \hv and $h_{\mathrm{v,approx}}$, when
  ...
  85\deg the difference is far below the 5\%.}  
\else
\caption[Diferencia entre alturas verticales \hv y $h_{\mathrm{v,approx}}$]%
{Diferencia entre alturas verticales \hv y $h_{\mathrm{v,approx}}$,
...
\begin{figure}[p]
  ...
  5\u{km}]{Image of a point-like source of light located at 5\u{km} in
    the vertical of the telescope, in different projection planes, at
    both sides of the overall focal plane: (a) when the telescope is
    focussed at infinity; and (b) when the telescope is focussed at
    10\u{km}} 
  \else
  \caption[Imagen de una fuente puntual situada a 5\u{km}]{Imagen 
    de una fuente puntual situada a 5\u{km} en la vertical del
    telescopio, vista en diferentes planos de proyecci'on a ambos
    lados del plano focal: (a) cuando el telescopio está enfocado al
    infinito; y (b) cuando está enfocado a 10\u{km}} 
  \fi
  \label{fig:hlfivekm}
\end{figure}}
...
\begin{figure}[p]
  ...
  10\u{km}]{Image of a point-like source of light located at 10\u{km}
    in the vertical of the telescope, in different projection planes,
    at both sides of the overall focal plane: (a) when the telescope
  ...
  \caption[Imagen de una fuente puntual situada a 10\u{km}]{Imagen 
    de una fuente puntual situada a 10\u{km} en la vertical del
    telescopio, vista en diferentes planos de proyecci'on a ambos
    lados del plano focal: (a) cuando el telescopio está enfocado al
    infinito; y (b) cuando está enfocado a 10\u{km}} 
  \fi
...
\begin{figure}[p]
  ...
  \caption[Imagen de una fuente puntual situada a 12\u{km}]{Imagen 
    de una fuente puntual situada a 12\u{km} en la vertical del
    telescopio, vista en diferentes planos de proyecci'on a ambos
    lados del plano focal: (a) cuando el telescopio está enfocado al
    infinito; y (b) cuando está enfocado a 10\u{km}} 
  \fi
...
\begin{figure}[p]
  ...
  100\u{km}]{Image of a point-like source of light located at
    100\u{km} in the vertical of the telescope, in different
    projection planes, at both sides of the overall focal plane: (a)
    when the telescope is focussed at infinity; and (b) when the
    telescope is focussed at 10\u{km}} 
  \else
  \caption[Imagen de una fuente puntual situada a 100\u{km}]{Imagen 
    de una fuente puntual situada a 100\u{km} en la vertical del
    telescopio, vista en diferentes planos de proyecci'on a ambos
    lados del plano focal: (a) cuando el telescopio está enfocado al
    infinito; y (b) cuando está enfocado a 10\u{km}} 
  \fi
...
\begin{figure}[p]
  ...
  \caption[Imagen de una fuente puntual en el infinito]{Imagen 
    de una fuente puntual en el infinito, en la vertical del
    telescopio, vista en diferentes planos de proyecci'on a ambos
    lados del plano focal: (a) cuando el telescopio está enfocado al
    infinito; y (b) cuando está enfocado a 10\u{km}} 
  \fi
...
\begin{figure}[p]
  ...
  plane]{Image of an \texttt{M} surrounded by a square in the camera
    plane (see above, the light comes from the white areas). The image
    is projected from a lamp located at height above the observation
    level of 10\u{km}, with the telescope pointing to the Zenith. The
    area in the ground covered by the image is just slightly larger
    that the dish of \MAGIC. The different images correspond to
    different distances of the projection plane to the dish, from
    1692\u{cm} to 1707\u{cm} (see text). Note that the scale is
    normalized to the maximum concentration of light (for 1700\u{cm})}
  \else
...
\begin{figure}[p]
  ...
  \fi
  \ifenglish
  \caption[Image of an point-like light source for different 
  angles]{Image of an point-like light source located at 10\u{km}
    above the observation level, in the vertical of \MAGIC, with the
    telescope pointing at the Zenith. Different \emph{off-axis} angles
    have been used, from 0\deg to 2.5\deg. The different rows of
    images correspond to: (a) perfect system, reflectivity 100\%; (b)
    to (f) realistic system, reflectivity 90\%, deviation of mirror
    axes from 0\u{mm} to 5\u{mm} in the camera plane (see text). Note
    that in this figure a logarithmic scale, normalized to the case of
    the maximum concentration of light --- first spot, 0\deg, in (a)
    --- has been applied} \else
  \caption[Imagen de una fuente puntual de luz a 10\u{km}]{Imagen de una
    ...
    nivel de observaci'on, en la vertical del telescopio, con 'este
    ...
    90\%, desviaci'on del apuntado de los ejes de los espejos de
    0\u{mm} a 5\u{mm}, en el plano de la c'amara (ver texto). N'otese
    que en esta figura se ha utilizado una escala de intensidades de
    luz logar'itmica, normalizada al caso de m'axima concentraci'on de
    luz --- primera imagen, 0\deg, del caso (a).}  \fi
...
\ifenglish
\caption[Representation of the idea of \emph{Effective Collection 
  Area}]{Representation of the idea of \emph{Effective Collection
    Area. The showers A to D will be detected. The shower E will not.}}
\else
