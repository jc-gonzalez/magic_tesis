...
\centering
\ifenglish
\includegraphics[width=0.95\textwidth]{gsources}
\caption[A Gamma-Ray Sources Skymap]{A Gamma-Ray Sources Skymap [??].}  
\else
\includegraphics[width=0.95\textwidth]{gsources_e}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.45\textwidth]{collimation}
\ifenglish
...
\begin{figure}[p]
\centering
\includegraphics[width=0.8\textwidth]{colldelta}
\ifenglish
...
\begin{figure}[tb]
  \begin{center}
    \includegraphics[width=0.8\textwidth]{qehistqe}
    \ifenglish
...
\begin{figure}[bt]
  \begin{center}
    \includegraphics[width=0.8\textwidth]{varwithp}
    \ifenglish
...
\begin{figure}[tb]
  \begin{center}
    \includegraphics[width=0.6\textwidth,angle=-90,clip=]{varwithqe}
    \ifenglish
