...
El telescopio \Cerenkov \I{MAGIC} (\emph{Mayor Advanced Gamma-rays
...
'optica}, mecanismo de posicionamiento r'apido para la observaci'on de
\I{GRB}s, sistema de disparo (\I{trigger}) multinivel, monitoraje de
la atm'osfera, etc.
...
hay s'olo tres remanentes de supernova (\emph{\Isee{supernov\ae\ 
    remnant}{SNR}}, \I{SNR}) observadas: la Nebula del Cangrejo (Crab
