...
camera, with a radius of $0.8\deg$. We made investigations also
varying the size of this area, and even using the whole camera, but
this is the canonical value of the radius. In Fig.\ref{fig:trigarea}
we see how big in the whole camera is this area. The estimation of
this radius is given as follows. We are interested mainly in the low
...
0.7\deg-0.8\deg$ for primaries in the energy range indicated. We chose
the larger, more conservative value of $0.8\deg$.
